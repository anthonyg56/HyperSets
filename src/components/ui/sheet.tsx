...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps & { closeHidden?: boolean }
>(({ side = "right", className, children, closeHidden, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay />
    ...
    >
      {children}
      <SheetPrimitive.Close className={cn(["absolute right-4 top-4 rounded-sm opacity-70 ring-offset-white transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-zinc-950 focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-zinc-100 dark:ring-offset-zinc-950 dark:focus:ring-zinc-300 dark:data-[state=open]:bg-zinc-800", {
        'hidden': closeHidden
      }])}>
