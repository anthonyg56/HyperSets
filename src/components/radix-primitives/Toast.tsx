...
import { toastSchema } from '@/lib/utils/schemas';
import { z } from 'zod';

const initalProps = toastSchema.partial({
  action: true
})

type Props = z.infer<typeof initalProps>

export default function Toast(props: Props) {
  const { description, action, title, isOpen, setOpen } = props
